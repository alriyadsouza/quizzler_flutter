...
class QuizBrain {
  ...
  void nextQuestion() => _questionNumber < _questionBank.length - 1 ? _questionNumber++ : _showQuizEndAlert();

  void _showQuizEndAlert() {
    Alert(
      context: context,
      type: AlertType.error,
      title: "QUIZ END",
      desc: "The quiz is over. Click below to restart the quiz.",
      buttons: [
        DialogButton(
          child: Text(
            "RESTART",
